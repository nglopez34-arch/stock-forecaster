...
"""
#todo:
# Make it so that this code runs continuously during the trading day, updating automatically every couple of minutes
...
def main():
    ...
    if os.path.exists("../data/raw_data.parquet"):
